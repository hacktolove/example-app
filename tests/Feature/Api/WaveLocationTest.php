...
class WaveLocationTest extends TestCase
{
    ...
    public function test_location_success(): void
    {
        Http::fake([
        ...
        $response = $this->postJson('/api/v1/wave/location', [
            'msisdn' => '249912345678',
            'content_id' => '1000',
        ]);
        ...
        Http::assertSent(function (Request $request): bool {
            return $request->url() === 'https://wave.example.test/DiameterEventCharging'
                ...
                && $request['command']['function'] === 'Location'
                && $request['command']['request']['MSISDN'] === '249912345678'
                && $request['command']['request']['ContentID'] === '1000';
        });
    }

    public function test_location_business_failure(): void
    {
        Http::fake([
            '*/DiameterEventCharging' => Http::response([
                'responseCode' => 4547,
